                            ...
                            for n2 = 10:100:1001
                                for n1 = 10:100:1001
                                    for num_times = 1:t
                                        ...
                                        %curr_table = table(mean1_arr, std1_arr, dist1_arr, n1_arr, dim1_arr, mean2_arr, std2_arr, dist2_arr, n2_arr, dim2_arr, matlab_time_arr, matlab_bound_arr, 'VariableNames', {'mean1' 'std1' 'dist1' 'n1' 'dim1' 'mean2' 'std2' 'dist2' 'n2' 'dim2' 'matlab_time' 'matlab_bound'});
                                        curr_table = table(mean1_arr', std1_arr', dist1_arr', n1_arr', dim1_arr', mean2_arr', std2_arr', dist2_arr', n2_arr', dim2_arr', matlab_time_arr', matlab_bound_arr', 'VariableNames', {'mean1' 'std1' 'dist1' 'n1' 'dim1' 'mean2' 'std2' 'dist2' 'n2' 'dim2' 'matlab_time' 'matlab_bound'});
                                        writetable(curr_table, "full_run_results_matlab.csv");
                                    end
                                end
                            end
