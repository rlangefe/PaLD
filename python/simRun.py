                                        ...
                                        for num_times in range(t):
                                            ...
                                            with cp.cuda.Device(1) as dev:
                                                ...
                                                if interactive == True:
                                                    ...
                                                    print("--- %s seconds ---" % (end_time - start_time))
                                                dev.synchronize()
                                                data_dict['time_pald_cupy_multistream'] = [end_time-start_time]
                                                data_dict['bound_pald_cupy_multistream'] = [cohesions.trace()/(dist_mat.shape[0]*2)]
                                                dev.synchronize()
                                            ...
                                            with cp.cuda.Device(1) as dev:
                                                ...
                                                if interactive == True:
                                                    ...
                                                    print("--- %s seconds ---" % (end_time - start_time))
                                                dev.synchronize()
                                                data_dict['time_pald_cupy_loop'] = [end_time-start_time]
                                                data_dict['bound_pald_cupy_loop'] = [cohesions.trace()/(dist_mat.shape[0]*2)]
                                                dev.synchronize()
